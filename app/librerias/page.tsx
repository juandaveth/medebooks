...
const title = "Librerías de Medellín";
const description =
  "Descubre las librerías del Área Metropolitana de Medellín en mapa y lista.";
...
export default async function LibreriasPage() {
  ...
  return <DirectoryShell places={places} facets={facets} initialType="libreria" />;
}
